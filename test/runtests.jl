...
# !!! Main.UserApp is configured as an alias for Main.EmmaWeb and you might encounter it in some tests
using Main.EmmaWeb, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "EmmaWeb tests" begin
  @includetests ARGS
end
